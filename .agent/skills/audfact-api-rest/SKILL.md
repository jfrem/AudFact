...
| Archivo | Tamaño | Rol |
|---|---|---|
| `app/Routes/web.php` | 880 B | Definición de 12 rutas |
...
| `app/Controllers/AuditController.php` | 1.7 KB | Orquestador de auditoría |
...
5. **No usar `exit()` o `die()`** — usar `Response::error()` que hace exit internamente.
