...
Use ID format `ARCH-001`, `ARCH-002`, ... from [../../_shared/references/finding-id-convention.md](../../_shared/references/finding-id-convention.md).
...
|--------|------------------|--------|----------------|-------------|-----------|------------|
| Architecture | | 100% (single-domain) | | Yes/No | | High/Medium/Low |
