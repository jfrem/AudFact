...
Use ID format `SEC-001`, `SEC-002`, ... from [../../_shared/references/finding-id-convention.md](../../_shared/references/finding-id-convention.md).
...
|--------|------------------|--------|----------------|-------------|-----------|------------|
| Security | | 100% (single-domain) | | Yes/No | | High/Medium/Low |
