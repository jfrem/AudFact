...
| `audfact-audit-gemini` | Auditoría IA | `app/Services/Audit/*` (raíz + Pipeline) | Pipeline event-driven con Gemini, scheduler justo `AuditPersistenceQueue`, telemetría y workers sobre Redis Streams. |
| `audfact-sqlsrv-models` | Datos SQL Server | `app/Models/*`, `core/Database.php`, `core/SqlServer*.php` | Modelos PDO sqlsrv, reconexión por operación, BLOBs y persistencia dual transaccional. |
...
| Bundle | Skills | Uso |
|---|---|---|
| `audfact-core` | `audfact-api-rest`, `audfact-sqlsrv-models`, `audfact-project-overview`, `audfact-docs-sync` | Cambios en API + Datos |
| `audfact-ai-audit` | `audfact-audit-gemini`, `audfact-sqlsrv-models`, `audfact-security-guardrails`, `audfact-docs-sync` | Pipeline de auditoría completo |
| `audfact-integration` | `audfact-mcp-wrap`, `audfact-api-rest`, `audfact-docs-sync` | Integración con agentes IA |
| `audfact-ops` | `audfact-runtime-docker`, `audfact-production-ops`, `audfact-security-guardrails`, `audfact-docs-sync` | Infraestructura, producción LAN y hardening |
| `audfact-tech-assessment` | `audit-skill-router`, `architecture-assessment`, `code-quality-assessment`, `security-assessment`, `technical-governance-assessment`, `audfact-docs-sync` | Auditorías técnicas integrales con score global |
...
| `app/Models/AuditResultPersistenceModel.php` | `audfact-sqlsrv-models` + `audfact-audit-gemini` |
| `core/Database.php` | `audfact-sqlsrv-models` |
| `core/SqlServerConnectionExecutor.php`, `core/SqlServerOperationMode.php`, `core/SqlServerOperationException.php` | `audfact-sqlsrv-models` |
| `app/Services/Audit/Pipeline/DocumentAuditOrchestrator.php` | `audfact-audit-gemini` |
| `app/Services/Audit/Pipeline/DocumentAttachmentMatcher.php`, `app/Services/Audit/Pipeline/DocumentAttachmentMatchResult.php`, `app/Services/Audit/Pipeline/DocumentMappingRejectionReason.php` | `audfact-audit-gemini` |
