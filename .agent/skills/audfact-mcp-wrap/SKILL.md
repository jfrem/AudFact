...
2. Registrar tools en `MCPServer`.
3. Ejecutar cada tool con `params`.
4. Resolver llamada interna via `ApiClient` → API REST local.
5. Retornar arreglo de resultados JSON.
