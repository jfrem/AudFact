...
LUA;
    ...
    private function parseStreamsResponse(mixed $raw): array
    {
        ...
        // Predis 2.x may return MultiBulk iterator objects instead of plain arrays.
        // Normalize the entire response tree before processing to avoid silent data loss.
