...
final class AuditFindingRulesNormalizationTest extends TestCase
{
    ...
    public static function numericDateProvider(): array
    {
        return [
            ...
            'ISO 8601 con zona horaria negativa' => ['2026-01-09T08:51:04.000-05:00', '2026-01-09'],
            'ISO 8601 con zona horaria positiva' => ['2026-01-09T08:51:04.000+05:00', '2026-01-09'],
